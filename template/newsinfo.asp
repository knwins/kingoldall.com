...
sql="select * from news where product_id="&newsid
                ...
                <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                          ...
                          <tr>
                            <td height="12" valign="top"><table width="770" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  ...
                                  <td width="211"><img src="images/019.jpg" width="194" height="27"></td>
                                  <td width="554" align="right"><A href="index.html">首页</A>　&gt;　 <%=typenames%>&gt; <%=product_name%></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table></td>
                    ...
                    <tr>
                      <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td valign="top" style="line-height:25px"><DIV>
                  <DIV align=left>
                    <div style="color:#000000; padding:15px 10px 15px 8px;">
                      <p style="font-size:14px; line-height:24px; font-weight:bold; padding-bottom:5px; text-align:center; margin:0px;"><%=product_name%></p>
                      <div><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" align="center">发布时间：<%=createdate%>&nbsp;&nbsp;浏览
                          <script src="count.asp?id=<%=newsid%>" language="javascript"></script>
                          次</td>
  </tr>
</table>
</div> 
                      <div style=" font-size:12px; line-height:25px; text-align:left;">
                        <% if url<>"" then%>
                        <p align="center"><img src="<%=url%>" alt="<%=product_name%>" /></p>
                        <% end if%>
