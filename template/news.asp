                          ...
                          <tr>
                            <td height="12" valign="top"><table width="770" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  ...
                                  <td width="262" align="right"><A href="index.html">��ҳ</A>��&gt;��<%=typenames%></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table></td>
...
%>
                              <tr>
                                ...
                                <td width="97%" height="35" align="left" style="border-bottom: #999999 1px dotted"><a href="news_<%= rs("product_id")%>.html"><%= rs("product_name") %></a>��<font color="#999999">[<%= rs("createdate") %>] ���
