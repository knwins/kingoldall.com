...
<table border="1" width="90%" align="center" bordercolorlight="#c0c0c0" cellspacing="1" cellpadding="3" bordercolordark="#ffffff" >
  <form name="myform" action=News_upd.asp method=post>
    ...
    <tr>
      ...
      <td width="80%"><input name=product_name size="60" value="<%=product_name%>"></td>
	    ...
	    <tr>
      <td>信息图片：</td>
      <td width="562" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF"><input name=s_image size=35 maxlength=50 value="<%=s_image%>">
          <input name="Submit" type="button" onClick="window.open('../upload_flash.asp?formname=myform&editname=s_image&uppath=pro_img/case&filelx=jpg','','status=no,scrollbars=no,top=20,left=110,width=420,height=165')" value="小图">
