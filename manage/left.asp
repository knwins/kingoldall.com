...
outlookbar.additem('<br>产品分类管理',t,'Product_Cate_List.asp?ver=cn')
outlookbar.additem('<br>产品信息管理',t,'Product_List.asp?ver=cn')
outlookbar.additem('<br>信息分类管理',t,'NewsCate_List.asp?ver=cn')
outlookbar.additem('<br>信息内容管理',t,'News_List.asp?ver=cn')
outlookbar.additem('<br>企业信息',t,'company.asp?ver=cn')
outlookbar.additem('<br>网站参数',t,'site.asp?id=1')
outlookbar.additem('<br>首页广告',t,'banner_list.asp?ver=cn')
outlookbar.additem('<br>静态页其他生成',t,'create_html_other.asp')
outlookbar.additem('产品页其他生成',t,'create_html_pro.asp')
