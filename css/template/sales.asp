...
<tr>
          ...
          <td width="820" align="left" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <param name="movie" value="https://www.kingoldall.com/swf/map.swf">
                <param name="quality" value="high">
                <param name="wmode" value="transparent">
                <embed src="https://www.kingoldall.com/swf/map.swf" quality="high" wmode="transparent" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="600" height="536">
